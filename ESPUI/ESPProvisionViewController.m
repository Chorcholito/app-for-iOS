...
- (void)viewDidLoad {
    ...
    // Configuración del botón de 'Back'
    ...
    // Configurar OpMode como STA por defecto
...
- (void)SetUI {
    ...
    // Ocultar device mode (label y botón)
    /*
    ...
    */
    ...
    // softAPView ------------
    UIView *Softview = [[UIView alloc]initWithFrame:CGRectMake(0, offset, [UIScreen mainScreen].bounds.size.width, Height * 4 + offset * 4)];
    ...
    SoftAPSecurityBtn.layer.cornerRadius = Height / 2;
    ...
    SoftAPchannelBtn.layer.cornerRadius = Height / 2;
    ...
    SoftAPMaxConnectBtn.layer.cornerRadius = Height / 2;
